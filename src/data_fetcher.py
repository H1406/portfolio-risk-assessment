...
df_stock = stock.quote.history(start='2021-01-01', end='2026-01-01', interval='1W')
print(df_stock.head())
...
gold_data = yf.download("XAUT-USD", start="2021-01-01", end="2026-01-01", interval="1wk")
...
btc_data = yf.download("BTC-USD", start="2021-01-01", end="2026-01-01", interval="1wk")
print(btc_data.head())
